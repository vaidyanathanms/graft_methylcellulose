...
function [figHndl,patchHndl,lineHndl] = plotCustMark(xData,yData,markerDataX,markerDataY,markerSize,mface,medge)
...
set(patchHndl,'FaceColor',mface,'EdgeColor',medge) ;
% -------------------------------------------------------------
